...
namespace MERP
{
    public partial class proje_duzenle : Form
    {
        ...
        public proje_duzenle()
        {
            InitializeComponent();
            hf = new HelperFunctions();
        }

        private void proje_duzenle_Load(object sender, EventArgs e)
        {
            server = "localhost";
        ...
        private void btn_harcamalar_Click(object sender, EventArgs e)
        {
            ...
            {
                flag = "P";
                harcama_ongorusu f1 = new harcama_ongorusu();
                f1.lbl_pdr.Text = "PDR";
                f1.lbl_cdr.Text = "CDR";
