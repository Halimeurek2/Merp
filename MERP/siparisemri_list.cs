...
namespace MERP
{
    public partial class siparisemri_list : Form
    {
        ...
        public siparisemri_list()
        {
            InitializeComponent();
        }

        private void satinalma_list_Load(object sender, EventArgs e)
        {
            server = "localhost";
        ...
        {
            siparisemri_duzenle obj = new siparisemri_duzenle();
            obj.lbl_id.Text = id;
